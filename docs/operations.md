...
`amber-trade-spread-gate` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for spread systems, covering resource planning, capacity fixtures, and failure-oriented tests.
