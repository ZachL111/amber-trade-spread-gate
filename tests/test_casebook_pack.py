"""Regression checks for the amber-trade-spread-gate casebook."""
...
from casebook.harness import assert_expected, amber_trade_spread_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_trade_spread_gate_summary(), assert_expected())
